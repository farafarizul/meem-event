...
class AggregateSilverPriceDaily extends Command
{
    protected $signature = 'silver-price:aggregate-daily
    ...
    protected $description = 'Aggregate daily silver price summary from silver_price table and generate AI reason via Groq.';

    public function handle(SilverPriceDailyAggregatorService $service): int
    {
    ...
    private function processSingleDate(SilverPriceDailyAggregatorService $service, string $date): int
    {
    ...
    private function processRange(SilverPriceDailyAggregatorService $service, string $from, string $to): int
    {
