                        ...
                        <div class="card-inner">
                            <div class="card-title-group">
                                <div class="card-title">
                                    <h6 class="title"><em class="icon ni ni-edit me-1"></em>Edit Branch</h6>
                                </div>
                                <div class="card-tools">
                                    <span class="badge bg-secondary font-monospace">{{ $branch->branch_code }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="card-inner">
                            <form action="{{ route('admin.branches.update', $branch) }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <select name="branch_type"
                                                    ...
                                                    <option value="Branch" {{ old('branch_type', $branch->branch_type) === 'Branch' ? 'selected' : '' }}>Branch</option>
                                                    <option value="HQ" {{ old('branch_type', $branch->branch_type) === 'HQ' ? 'selected' : '' }}>HQ</option>
                                                </select>
                                                @error('branch_type')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" name="person_in_charge_name"
                                                    ...
                                                    value="{{ old('person_in_charge_name', $branch->person_in_charge_name) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" name="person_in_charge_phone"
                                                    ...
                                                    value="{{ old('person_in_charge_phone', $branch->person_in_charge_phone) }}">
                                ...
                                <div class="mt-4 d-flex gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <em class="icon ni ni-save me-1"></em>Update Branch
                                    </button>
