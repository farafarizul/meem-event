        ...
        <div class="col-md-7">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white">
                    <h6 class="mb-0 fw-semibold"><i class="bi bi-gear me-1"></i>Silver Price Sync Settings</h6>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.silver-price.settings.update') }}">
                        ...
                        <a href="{{ route('admin.silver-price.index') }}" class="btn btn-outline-secondary ms-2">
                            <i class="bi bi-arrow-left me-1"></i>Back to Silver Price History
                        </a>
                    </form>
                </div>
            </div>
