<x-app-layout>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center flex-wrap gap-2">
            <h6 class="mb-0 fw-semibold"><i class="bi bi-graph-up-arrow me-1"></i>All Gold Price Records</h6>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="gold-price-table" class="table table-hover align-middle w-100">
