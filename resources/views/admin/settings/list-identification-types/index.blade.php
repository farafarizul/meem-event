<x-app-layout>
    <x-slot name="header">List of Identification Types</x-slot>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center flex-wrap gap-2">
            <h6 class="mb-0 fw-semibold"><i class="bi bi-card-list me-1"></i>All Identification Types</h6>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="list-identification-types-table" class="table table-hover align-middle w-100">
    ...
    @push('scripts')
    <script>
        var table = $('#list-identification-types-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: '{{ route('admin.settings.list-identification-types.datatable') }}',
                type: 'GET'
            },
            columns: [
                { data: 'DT_RowIndex',            name: 'DT_RowIndex',            orderable: false, searchable: false, width: '50px' },
                { data: 'identification_type_id', name: 'identification_type_id', width: '80px' },
        ...
        $('#btn-sync').on('click', function () {
            ...
            $.ajax({
                url: '{{ route('admin.settings.list-identification-types.sync') }}',
                method: 'POST',
