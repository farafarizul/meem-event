<x-app-layout>
    <x-slot name="header">List of States</x-slot>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center flex-wrap gap-2">
            <h6 class="mb-0 fw-semibold"><i class="bi bi-map me-1"></i>All States</h6>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="list-states-table" class="table table-hover align-middle w-100">
    ...
    @push('scripts')
    <script>
        var table = $('#list-states-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: '{{ route('admin.settings.list-states.datatable') }}',
                type: 'GET'
            },
            columns: [
                { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false, width: '50px' },
                { data: 'state_id',    name: 'state_id',    width: '80px' },
        ...
        $('#btn-sync').on('click', function () {
            ...
            $.ajax({
                url: '{{ route('admin.settings.list-states.sync') }}',
                method: 'POST',
