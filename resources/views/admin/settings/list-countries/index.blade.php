<x-app-layout>
    <x-slot name="header">List of Countries</x-slot>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center flex-wrap gap-2">
            <h6 class="mb-0 fw-semibold"><i class="bi bi-globe me-1"></i>All Countries</h6>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="list-countries-table" class="table table-hover align-middle w-100">
    ...
    @push('scripts')
    <script>
        var table = $('#list-countries-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: '{{ route('admin.settings.list-countries.datatable') }}',
                type: 'GET'
            },
            columns: [
                { data: 'DT_RowIndex', name: 'DT_RowIndex',  orderable: false, searchable: false, width: '50px' },
                { data: 'country_id',  name: 'country_id',   width: '80px' },
        ...
        $('#btn-sync').on('click', function () {
            ...
            $.ajax({
                url: '{{ route('admin.settings.list-countries.sync') }}',
                method: 'POST',
